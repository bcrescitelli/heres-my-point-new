...
const ROUND_DETAILS = {
  ...
  3: {
    title: "The Face-Off",
    description: "Random pairings. One topic. At 15s, SWITCH! Player 2 must defend the opposite side!",
      ...
      <div className="min-h-screen bg-indigo-950 text-white flex flex-col items-center justify-center p-8 font-sans overflow-hidden uppercase">
        <div className="max-w-md w-full text-center space-y-12 animate-in fade-in zoom-in duration-500">
          ...
          <div className="grid gap-6">
            <button onClick={createRoom} className="group relative bg-indigo-600 hover:bg-indigo-500 p-8 rounded-[2.5rem] flex items-center justify-between border-b-8 border-indigo-900 shadow-2xl overflow-hidden leading-none uppercase"><div className="text-left relative z-10"><p className="font-black text-2xl uppercase italic leading-none mb-1 text-white uppercase">Host Show</p><p className="text-indigo-300 text-sm font-bold">Project on the Big Screen</p></div><Monitor className="w-12 h-12 text-indigo-300 group-hover:text-yellow-400 transition-colors relative z-10" /></button>
            <div className="bg-indigo-900/40 p-8 rounded-[2.5rem] border-2 border-indigo-800 space-y-6 text-left shadow-xl uppercase">
              <div className="flex items-center gap-2 text-indigo-300 relative z-10 uppercase"><Smartphone className="w-5 h-5 uppercase" /><p className="font-black uppercase text-[10px] tracking-[0.2em] uppercase">Join the Party</p></div>
    ...
    <div className="min-h-screen bg-indigo-950 text-white flex flex-col font-sans overflow-hidden select-none uppercase leading-none">
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 md:p-12 relative text-center overflow-hidden uppercase">
        ...
        {room.status === 'ROUND_INTRO' && (
          <div className="space-y-8 animate-in slide-in-from-bottom duration-700 max-w-3xl w-full leading-none uppercase">
            <div className="flex justify-center mb-6 drop-shadow-2xl leading-none uppercase">{ROUND_DETAILS[room.roundType].icon}</div>
            ...
            <div className="bg-white/5 border border-white/10 p-8 md:p-10 rounded-[3rem] backdrop-blur-md shadow-2xl leading-none uppercase">
              <p className="text-xl md:text-2xl text-indigo-100 font-medium leading-tight leading-none uppercase uppercase">{ROUND_DETAILS[room.roundType].description}</p>
            </div>
        ...
        {room.status === 'TOPIC_REVEAL' && (
          <div className="space-y-12 animate-in zoom-in duration-500 w-full max-w-5xl leading-none uppercase uppercase">
            <div className="space-y-4 uppercase uppercase"><p className="text-yellow-400 font-black uppercase tracking-[0.3em] text-xs italic leading-none leading-none uppercase uppercase">The Controversy</p><h2 className="text-5xl md:text-8xl font-black italic leading-tight text-white drop-shadow-lg break-words leading-none leading-none uppercase uppercase uppercase uppercase">"{room.topic}"</h2></div>
